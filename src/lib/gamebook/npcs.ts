...
export interface NpcDefinition {
    ...
    /** `tint` = filtre CSS de personnalisation (hue-rotate/saturate/brightness) appliqué EN PLUS de l'ombre —
     *  sert au REFLET de la Ligue de Fusion, qui porte l'avatar exact du joueur (teinte comprise). */
    gen3?: { url: string; col?: number; row?: number; tint?: string }
    ...
    */
    ...
    },
    {
        ...
        dialoguesAfter: [
            ...
            "*Il pointe vers le sud, l'air sérieux.*",
            "Et avant d'attaquer le Mont, RETIENS-MOI BIEN ÇA :",
            "Là-haut, ton rythme de pédalage est TOUT. Appuie sur ↑ une fois par seconde environ.",
            "La jauge BPM doit rester DANS LE VERT (60-80). Ça divise ton coût par 2.",
            "Si tu rames ou tu paniques, tu paies jusqu'à 6× plus cher. J'ai vu des potes y laisser 2000 reps pour rien.",
        ],
    },
    // ============================================================
    ...
    // ============================================================
    {
        ...
        dialoguesAfter: [
            ...
            "Écoute bien, parce que ça peut te sauver 1500 reps :",
            "Tout est question de RYTHME. Appuie sur ↑ régulièrement, environ 1 fois par seconde.",
            "Une jauge BPM en haut te montre où tu en es. Vise la ZONE VERTE (60-80 BPM).",
            "Dans la zone verte, tu paies MOITIÉ moins (×0.5). En-dehors, tu paies jusqu'à 6× plus cher !",
            "Exemple : avec le Vieux Vélo, le sommet coûte 400 reps en bon rythme, 2400 reps si tu rames.",
