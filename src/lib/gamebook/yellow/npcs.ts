...
export const YELLOW_NPCS: NpcDefinition[] = [
    ...
    // === ARÈNE ÉLECTRIQUE — panneau-antisèche (Tour Hertz, près de l'entrée) ===
    {
        ...
        dialoguesAfter: [
            ...
            "⚡ LA TOUR HERTZ est 100% ÉLECTRIK.",
            "🌍 Ton arme reine : le SOL. Il frappe l'Élec ×2 — et la foudre ne peut même PAS toucher un Daemon Sol (×0). Ta meilleure clé pour cette tour.",
            "⛏️ Tes gros coups ici : Séisme (CT Champion, dispo dès 3 badges) et Faille Sismique (cadeau de l'arène Roche).",
            "💪 Les attaques SOL sont PHYSIQUES → c'est ton ATTAQUE qui fait mal : monte-la.",
            "🛡️ La foudre frappe en SPÉCIAL : c'est ta SPÉ qui encaisse, pas ta Déf. Soigne-la avant de grimper.",
            "🚫 N'amène ni EAU ni VOL : l'Élec leur fait ×2.",
            "🗝️ Bats les 4 gardes (ordre libre), puis VOLTA au sommet — et son redoutable Voltapanthe.",
        ],
    },
