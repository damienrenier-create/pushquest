...
export const FUSION_RULES: string[] = [
    ...
    "④ TYPES (règle précise) — Le fusionné garde UN type de CHAQUE parent : pour chaque parent, on conserve celui de ses types le plus FIDÈLE aux grosses stats du fusionné (l'autre est abandonné). Chaque type a une STAT REPRÉSENTATIVE, et le type dont cette stat est la plus HAUTE chez le fusionné l'emporte — PV : Ténèbres · Attaque : Combat, Insecte, Dragon · Défense : Plante, Eau, Roche, Sol, Métal · Vitesse : Feu, Normal, Vol, Élec, Fée, Spectre · Spéciale : Glace, Psy, Poison. Résultat : un type par parent = un BI-TYPE (le type du parent « tête » s'affiche en premier ; le STAB se moque de l'ordre).",
