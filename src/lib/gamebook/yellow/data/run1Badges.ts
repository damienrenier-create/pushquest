...
export const RUN1_DEX_TOTAL = RUN1_SPECIES.length // 141 (dont Osquille + Rô, pêchables). Exclut Sylvebarbe(133) &
// Géckèbre(180) désormais postLeague (endgame post-Ligue / Zone de Combat), comme leurs cousins Gavillus/Goatiny/B2F.
...
export const BADGES: readonly BadgeDef[] = [
    ...
    { id: "fusleague_bronze_run", label: "Boucler le palier BRONZE de la Ligue de Fusion", tier: "gold", secret: true, cat: "fusion", earned: (i) => hasMk(i, MK_FUSION_BRONZE), reveal: (i) => hasMk(i, MK_AUTEL) || hasMk(i, MK_FUSION_UNLOCK), points: fusionTierPoints("bronze", 40, 3, 10) },
    { id: "fusleague_argent_run", label: "Boucler le palier ARGENT de la Ligue de Fusion", tier: "diamond", secret: true, cat: "fusion", earned: (i) => hasMk(i, MK_FUSION_ARGENT), reveal: (i) => hasMk(i, MK_FUSION_BRONZE), points: fusionTierPoints("argent", 80, 5, 20) },
    { id: "fusion_gold", label: "Champion OR de la Ligue de Fusion", tier: "legend", secret: true, cat: "fusion", earned: (i) => hasMk(i, MK_FUSION_OR), reveal: (i) => hasAnyMk(i, MK_FUSION_TIERS), points: fusionTierPoints("or", 150, 8, 30) },
