...
// MOVESETS CURÉS des 21 fusions de Ligue : chaque paire porte un `moves` de 4 attaques (override du dérivé).
...
describe("Ligue de Fusion — movesets curés", () => {
    it("les 21 fusions ont un moveset curé de 4 attaques, toutes des ids réels", () => {
