...
export const SPECIES: Record<string, SpeciesData> = {
    ...
    // --- Lignée 1 : Fossile « remonte le temps » (Roche/Vol, rapide physique) ---
    dodoche: {
        id: "dodoche", dexNo: 74, name: "Dodoche", types: ["ROCHE", "VOL"],
        baseStats: { hp: 50, atk: 55, def: 50, spe: 60, spc: 38 },
        learnset: [{ level: 1, moveId: "charge" }, { level: 1, moveId: "picpic" }, { level: 7, moveId: "jet_pierres" }, { level: 12, moveId: "vive_attaque" }],
        evolution: { toId: "raptoroc", method: { kind: "LEVEL", level: 18 } },
        catchRate: 120, baseExp: 62, rarity: "COMMON", growthRate: "medium_fast", role: "Roche/Vol — fossile (bébé)",
        description: "Oiseau préhistorique trapu aux grandes pattes ; vestige d'un autre âge.",
        sprite: "/yellow/sprites/dex/dodoche.png",
    },
    raptoroc: {
        id: "raptoroc", dexNo: 75, name: "Raptoroc", types: ["ROCHE", "VOL"],
        baseStats: { hp: 68, atk: 82, def: 62, spe: 88, spc: 48 },
        ...
        evolution: { toId: "tyrannoche", method: { kind: "LEVEL", level: 38 } },
        catchRate: 60, baseExp: 142, rarity: "UNCOMMON", growthRate: "medium_fast", role: "Roche/Vol — rapace fossile",
        description: "Raptor au bec de dodo ; il remonte le temps en évoluant.",
        sprite: "/yellow/sprites/dex/raptoroc.png",
    },
    tyrannoche: {
        id: "tyrannoche", dexNo: 76, name: "Tyrannoche", types: ["ROCHE", "VOL"],
        baseStats: { hp: 92, atk: 122, def: 88, spe: 92, spc: 58 },
        ...
        catchRate: 45, baseExp: 210, rarity: "RARE", growthRate: "medium_fast", role: "Roche/Vol — tyran fossile",
        description: "Colosse façon T-Rex au bec de dodo ; le plus ancien des fossiles.",
        sprite: "/yellow/sprites/dex/tyrannoche.png",
    },

    // --- Lignée 2 : Diamant « doublement » — 9 STADES (mur ultime) ---
    mottoche: {
        id: "mottoche", dexNo: 77, name: "Mottoche", types: ["ROCHE", "SOL"],
        baseStats: { hp: 45, atk: 40, def: 55, spe: 25, spc: 30 },
        learnset: [{ level: 1, moveId: "charge" }, { level: 1, moveId: "jet_pierres" }],
        evolution: { toId: "dumotte", method: { kind: "LEVEL", level: 8 } },
        catchRate: 140, baseExp: 40, rarity: "COMMON", growthRate: "medium_fast", role: "Roche/Sol — motte",
        description: "Une petite boule de terre qui roule.",
        sprite: "/yellow/sprites/dex/mottoche.png",
    },
    dumotte: {
        id: "dumotte", dexNo: 78, name: "Dumotte", types: ["ROCHE", "SOL"],
        baseStats: { hp: 55, atk: 48, def: 68, spe: 28, spc: 36 },
        learnset: [{ level: 1, moveId: "charge" }, { level: 1, moveId: "jet_pierres" }, { level: 1, moveId: "tir_boue" }],
        evolution: { toId: "quadroc", method: { kind: "LEVEL", level: 12 } },
        catchRate: 120, baseExp: 60, rarity: "COMMON", growthRate: "medium_fast", role: "Roche/Sol — 2 mottes",
    ...
    quadroc: {
        ...
        baseStats: { hp: 65, atk: 56, def: 82, spe: 30, spc: 42 },
        learnset: [{ level: 1, moveId: "jet_pierres" }, { level: 1, moveId: "tir_boue" }, { level: 1, moveId: "eboulis" }],
        evolution: { toId: "octoroc", method: { kind: "LEVEL", level: 16 } },
        catchRate: 90, baseExp: 86, rarity: "UNCOMMON", growthRate: "medium_fast", role: "Roche/Sol — 4 cailloux",
    ...
    octoroc: {
        ...
        baseStats: { hp: 75, atk: 66, def: 96, spe: 32, spc: 48 },
        learnset: [{ level: 1, moveId: "eboulis" }, { level: 1, moveId: "tir_boue" }, { level: 1, moveId: "mur_de_fer" }],
        evolution: { toId: "hexaroc", method: { kind: "LEVEL", level: 20 } },
        catchRate: 70, baseExp: 112, rarity: "UNCOMMON", growthRate: "medium_fast", role: "Roche/Sol — 8 cailloux",
    ...
    hexaroc: {
        ...
        baseStats: { hp: 85, atk: 76, def: 110, spe: 34, spc: 54 },
        learnset: [{ level: 1, moveId: "eboulis" }, { level: 1, moveId: "mur_de_fer" }, { level: 1, moveId: "tir_boue" }, { level: 26, moveId: "seisme" }],
        evolution: { toId: "diamantine", method: { kind: "LEVEL", level: 26 } },
        catchRate: 50, baseExp: 140, rarity: "RARE", growthRate: "medium_fast", role: "Roche/Sol — 16 cailloux",
    ...
    diamantine: {
        ...
        baseStats: { hp: 92, atk: 84, def: 122, spe: 38, spc: 64 },
        learnset: [{ level: 1, moveId: "eboulis" }, { level: 1, moveId: "mur_de_fer" }, { level: 1, moveId: "lame_roche" }, { level: 1, moveId: "seisme" }],
        evolution: { toId: "amadiam", method: { kind: "LEVEL", level: 32 } },
        catchRate: 35, baseExp: 170, rarity: "RARE", growthRate: "medium_fast", role: "Roche — 32 cailloux diamant",
    ...
    amadiam: {
        ...
        baseStats: { hp: 100, atk: 94, def: 132, spe: 40, spc: 74 },
        learnset: [{ level: 1, moveId: "lame_roche" }, { level: 1, moveId: "mur_de_fer" }, { level: 1, moveId: "seisme" }, { level: 1, moveId: "eboulis" }],
        evolution: { toId: "golemini", method: { kind: "LEVEL", level: 39 } },
        catchRate: 30, baseExp: 200, rarity: "RARE", growthRate: "medium_fast", role: "Roche — amas de 64 diamants",
    ...
    golemini: {
        ...
        baseStats: { hp: 108, atk: 104, def: 140, spe: 44, spc: 84 },
        learnset: [{ level: 1, moveId: "lame_roche" }, { level: 1, moveId: "seisme" }, { level: 1, moveId: "mur_de_fer" }, { level: 1, moveId: "belier" }],
        evolution: { toId: "megalithe", method: { kind: "LEVEL", level: 47 } },
        catchRate: 25, baseExp: 240, rarity: "RARE", growthRate: "medium_fast", role: "Roche — petit golem de diamant",
    ...
    megalithe: {
        ...
        baseStats: { hp: 120, atk: 116, def: 150, spe: 46, spc: 92 },
        learnset: [{ level: 1, moveId: "lame_roche" }, { level: 1, moveId: "seisme" }, { level: 1, moveId: "mur_de_fer" }, { level: 1, moveId: "eboulis" }, { level: 50, moveId: "belier" }],
        catchRate: 20, baseExp: 280, rarity: "RARE", growthRate: "medium_fast", role: "Roche — méga golem de diamant (mur ultime)",
        description: "Titan de diamant ; le mur le plus infranchissable connu.",
    ...
    limaroche: {
        ...
        baseStats: { hp: 55, atk: 40, def: 58, spe: 25, spc: 55 },
        ...
        catchRate: 120, baseExp: 60, rarity: "UNCOMMON", growthRate: "medium_fast", role: "Roche/Psy — limace",
    ...
    escaroche: {
        ...
        baseStats: { hp: 72, atk: 52, def: 78, spe: 32, spc: 72 },
        ...
        catchRate: 60, baseExp: 130, rarity: "RARE", growthRate: "medium_fast", role: "Roche/Psy — escargot",
    ...
    torturoche: {
        ...
        baseStats: { hp: 92, atk: 66, def: 100, spe: 40, spc: 100 },
        learnset: [{ level: 1, moveId: "vague_mentale" }, { level: 1, moveId: "lame_roche" }, { level: 1, moveId: "eboulis" }, { level: 1, moveId: "choc_mental" }, { level: 40, moveId: "focalisation" }, { level: 44, moveId: "mur_de_fer" }],
        catchRate: 45, baseExp: 195, rarity: "RARE", growthRate: "medium_fast", role: "Roche/Psy — tortue (tank spé)",
    ...
    marmoterre: {
        ...
        baseStats: { hp: 58, atk: 52, def: 55, spe: 40, spc: 40 },
    ...
    iorours: {
        ...
        baseStats: { hp: 80, atk: 80, def: 72, spe: 48, spc: 56 },
        ...
        catchRate: 50, baseExp: 145, rarity: "RARE", growthRate: "medium_fast", role: "Roche/Glace — ourse polaire",
    ...
    yetiroche: {
        ...
        baseStats: { hp: 104, atk: 108, def: 90, spe: 54, spc: 70 },
        learnset: [{ level: 1, moveId: "souffle_polaire" }, { level: 1, moveId: "lame_roche" }, { level: 1, moveId: "belier" }, { level: 1, moveId: "eboulis" }, { level: 44, moveId: "danse_lames" }],
        catchRate: 45, baseExp: 205, rarity: "RARE", growthRate: "medium_fast", role: "Roche/Glace — yéti (mur physique)",
        description: "Yéti légendaire des sommets ; sa poigne broie la pierre gelée.",
        sprite: "/yellow/sprites/dex/yetiroche.png",
    },

    // --- Lignée 5 : Têtard/grenouille-archère/crapaud (Roche → Roche/Combat) ---
    tetardoc: {
        id: "tetardoc", dexNo: 92, name: "Têtardoc", types: ["ROCHE"],
        baseStats: { hp: 50, atk: 52, def: 54, spe: 50, spc: 40 },
        learnset: [{ level: 1, moveId: "charge" }, { level: 1, moveId: "jet_pierres" }, { level: 10, moveId: "vive_attaque" }],
        evolution: { toId: "grenarc", method: { kind: "LEVEL", level: 18 } },
        catchRate: 120, baseExp: 60, rarity: "UNCOMMON", growthRate: "medium_fast", role: "Roche — têtard",
        description: "Têtard à carapace de galet ; vise déjà juste.",
        sprite: "/yellow/sprites/dex/tetardoc.png",
    },
    grenarc: {
        id: "grenarc", dexNo: 93, name: "Grenarc", types: ["ROCHE"],
        baseStats: { hp: 66, atk: 72, def: 62, spe: 78, spc: 52 },
        learnset: [{ level: 1, moveId: "jet_pierres" }, { level: 1, moveId: "picpic" }, { level: 1, moveId: "eboulis" }, { level: 24, moveId: "fonce_bec" }],
        evolution: { toId: "crapotaure", method: { kind: "LEVEL", level: 36 } },
        catchRate: 60, baseExp: 132, rarity: "RARE", growthRate: "medium_fast", role: "Roche — grenouille archère",
        description: "Grenouille armée d'un arc de pierre ; tireuse d'élite.",
        sprite: "/yellow/sprites/dex/grenarc.png",
    },
    crapotaure: {
        id: "crapotaure", dexNo: 94, name: "Crapôtaure", types: ["ROCHE", "COMBAT"],
        baseStats: { hp: 86, atk: 112, def: 80, spe: 92, spc: 60 },
        learnset: [{ level: 1, moveId: "lame_roche" }, { level: 1, moveId: "crochet_maitre" }, { level: 1, moveId: "fonce_bec" }, { level: 1, moveId: "eboulis" }, { level: 40, moveId: "balayage" }, { level: 44, moveId: "danse_lames" }],
        catchRate: 45, baseExp: 200, rarity: "RARE", growthRate: "medium_fast", role: "Roche/Combat — crapaud archer",
        description: "Crapaud colossal au grand arc ; ses flèches percent le roc.",
        sprite: "/yellow/sprites/dex/crapotaure.png",
    },

    // --- Lignée 6 : Mante/scarabée/scolopendre spectral (Insecte/Spectre) ---
    mantispectre: {
        id: "mantispectre", dexNo: 95, name: "Mantispectre", types: ["INSECTE", "SPECTRE"],
        baseStats: { hp: 48, atk: 58, def: 46, spe: 66, spc: 52 },
        learnset: [{ level: 1, moveId: "leche" }, { level: 1, moveId: "dard_nuee" }, { level: 12, moveId: "ombre_furtive" }],
        evolution: { toId: "scarabome", method: { kind: "LEVEL", level: 20 } },
        catchRate: 90, baseExp: 70, rarity: "UNCOMMON", growthRate: "medium_fast", role: "Insecte/Spectre — mante",
        description: "Mante religieuse fantomatique ; surgit du néant.",
        sprite: "/yellow/sprites/dex/mantispectre.png",
    },
    scarabome: {
        id: "scarabome", dexNo: 96, name: "Scarabôme", types: ["INSECTE", "SPECTRE"],
        baseStats: { hp: 64, atk: 78, def: 62, spe: 82, spc: 66 },
        learnset: [{ level: 1, moveId: "leche" }, { level: 1, moveId: "morsure" }, { level: 1, moveId: "ombre_furtive" }, { level: 30, moveId: "ball_ombre" }],
        evolution: { toId: "scolofantome", method: { kind: "LEVEL", level: 38 } },
        catchRate: 50, baseExp: 142, rarity: "RARE", growthRate: "medium_fast", role: "Insecte/Spectre — scarabée",
        description: "Scarabée spectral à la carapace translucide.",
        sprite: "/yellow/sprites/dex/scarabome.png",
    },
    scolofantome: {
        id: "scolofantome", dexNo: 97, name: "Scolofantôme", types: ["INSECTE", "SPECTRE"],
        baseStats: { hp: 82, atk: 100, def: 72, spe: 96, spc: 78 },
        ...
        catchRate: 45, baseExp: 200, rarity: "RARE", growthRate: "medium_fast", role: "Insecte/Spectre — scolopendre (rapide offensif)",
        description: "Scolopendre spectral interminable ; il transperce l'âme.",
        sprite: "/yellow/sprites/dex/scolofantome.png",
    },
}
