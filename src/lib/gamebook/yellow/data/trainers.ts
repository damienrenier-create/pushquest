...
export const TRAINERS: TrainerData[] = [
    ...
    // === GROTTE GELÉE — les 5 FRÈRES GLAÇON (dresseurs press-A). Les vaincre TOUS LES CINQ (peu importe l'ordre)
    //     octroie la CT61 « Voile de Givre » (câblé dans battleStore). Équipes Glace, run 2/3 via SIGHT_RUN_TEAMS. ===
    {
        id: "y_frere_frisquet",
        name: "FRISQUET",
        title: "Frère Glaçon",
        sprite: { emoji: "🥶", color: "#7fc7e8" },
        mapId: "yellow_grotte_gelee",
        x: 4, y: 6,
        team: [
            { speciesId: "auroruff", level: 16 }, { speciesId: "marmoterre", level: 16 },
        ],
        reward: 240,
        aiLevel: "trainer",
        intro: ["Brrr… moi c'est FRISQUET, le p'tit dernier des cinq frères Glaçon !", "Bats-nous tous les cinq et la récompense givrée sera à toi. En garde !"],
        victory: ["R-r-raté pour moi… mais mes grands frères vont te congeler !"],
        defeat: ["Hé hé ! Même le p'tit Frisquet t'a refroidi !"],
    },
    {
        id: "y_frere_grelot",
        name: "GRELOT",
        title: "Frère Glaçon",
        sprite: { emoji: "🔔", color: "#6bb8de" },
        mapId: "yellow_grotte_gelee",
        x: 12, y: 4,
        team: [
            { speciesId: "glacirex", level: 18 }, { speciesId: "glaceer", level: 18 },
        ],
        reward: 280,
        aiLevel: "trainer",
        intro: ["*Il grelotte en faisant tinter des glaçons.*", "GRELOT, deuxième des frères Glaçon ! J'ai la tremblote… mais mes Daemons mordent !"],
        victory: ["B-b-bien joué… il te reste des frères à geler !"],
        defeat: ["Tu grelotteras avant moi !"],
    },
    {
        id: "y_frere_glagla",
        name: "GLAGLA",
        title: "Frère Glaçon",
        sprite: { emoji: "❄️", color: "#5aa8d6" },
        mapId: "yellow_grotte_gelee",
        x: 22, y: 11,
        team: [
            { speciesId: "marmoterre", level: 20 }, { speciesId: "glaceer", level: 20 },
        ],
        reward: 320,
        aiLevel: "trainer",
        intro: ["GLAGLA ! *rire glacé* C'est mon nom ET le bruit que tu feras en perdant !", "Troisième frère, planté au fond du couloir gelé. On ne passe pas !"],
        victory: ["Glagla… j'ai fondu. Va voir les grands."],
        defeat: ["Gla-gla-gla ! Bien trop froid pour toi !"],
    },
    {
        id: "y_frere_givre",
        name: "GIVRÉ",
        title: "Frère Glaçon",
        sprite: { emoji: "🧊", color: "#4a97cc" },
        mapId: "yellow_grotte_gelee",
        x: 9, y: 28,
        team: [
            { speciesId: "iorours", level: 22 }, { speciesId: "glaceer", level: 22 }, { speciesId: "panthegel", level: 23 },
        ],
        reward: 400,
        aiLevel: "trainer",
        intro: ["Héhéhé… GIVRÉ, quatrième du nom.", "Gelé de la tête aux pieds ET du ciboulot ! Prépare-toi au grand frisson !"],
        victory: ["Givré mais pas rancunier… l'aîné t'attend, tout au bout."],
        defeat: ["Complètement givré — et gagnant !"],
    },
    {
        id: "y_frere_blizzard",
        name: "BLIZZARD",
        title: "Aîné des Glaçon",
        sprite: { emoji: "🌨️", color: "#2f7fc0" },
        mapId: "yellow_grotte_gelee",
        x: 24, y: 28,
        team: [
            { speciesId: "iorours", level: 24 }, { speciesId: "glaceer", level: 24 }, { speciesId: "morrow", level: 25 }, { speciesId: "orcaline", level: 26 },
        ],
        reward: 520,
        aiLevel: "ace",
        training: "elite",
        intro: ["*Une tempête se lève dans la caverne.*", "Je suis BLIZZARD, l'aîné des frères Glaçon.", "Affronte l'hiver en personne — et prie pour avoir déjà battu mes cadets !"],
    ...
    {
        id: "y_fusion_1", name: "WILL", title: "Conseil des Chimères",
        ...
        intro: [
            ...
            "Toute ma vie j'ai cherché la perfection PSYCHIQUE — et je l'ai trouvée dans la fusion : deux esprits ne faisant plus qu'un.",
            "Mes chimères liront tes mouvements avant même que tu ne les penses. Assez parlé — montre-moi les tiennes !",
        ],
        defeat: ["Mes chimères parfaites… lues à jour. Passe. Le reste du Conseil t'attend, et l'on ne recule pas ici."],
    },
    {
        id: "y_fusion_2", name: "KOGA", title: "Conseil des Chimères",
        sprite: { emoji: "☠️", color: "#5faa4d" },
        ...
        intro: [
            ...
            "La patience est une arme mortelle. Voyons combien de temps tes fusions tiennent !",
        ],
        defeat: ["Mes toxines… déjouées. Impressionnant. Avance — le Conseil ne fait que se durcir."],
    },
    {
        id: "y_fusion_3", name: "BRUNO", title: "Conseil des Chimères",
        ...
        intro: [
            ...
            "Nous ne ferons qu'un, mes chimères et moi, pour te broyer. En garde !",
        ],
        defeat: ["Broyé par plus fort que mes colosses… Avance. L'avant-dernier siège est le plus cruel."],
    },
    {
        id: "y_fusion_4", name: "KAREN", title: "Conseil des Chimères",
        sprite: { emoji: "🌙", color: "#34495e" },
        ...
        intro: [
            ...
            "La force n'est rien face au style. Montre-moi de belles fusions… et je te montrerai les TÉNÈBRES.",
        ],
        defeat: ["Superbe. Tes chimères sont fortes ET belles. Va — le Champion des Chimères t'attend."],
    },
    {
        id: "y_fusion_maitre", name: "LANCE", title: "Champion des Chimères",
        sprite: { emoji: "🐉", color: "#e17055" },
        mapId: "yellow_fusion_maitre", x: 10, y: 2,
        requiresTrainers: ["y_fusion_4"],
        team: [{ speciesId: "leviathonn", level: 80 }],
        reward: 0, aiLevel: "hof",
        intro: [
            "*Cape au vent, sur un trône d'écailles.* Te voilà. Le Conseil t'a jugé digne… on verra.",
            "Je suis LANCE, Maître Dragon et Champion des Chimères. Mes fusions sont l'apogée de l'art : deux légendes soudées en une seule bête ailée.",
            "Et pour finir, mon ACE — un colosse dragon qu'aucun challenger n'a jamais fait plier.",
            "Bats-moi, et il ne te restera qu'un dernier adversaire… le plus terrible de tous.",
        ],
        defeat: ["« …Mes dragons-chimères, à terre. Inconcevable. Tu es prêt. Mais es-tu prêt à affronter CELUI qui t'a tout appris ? »"],
    },
    {
