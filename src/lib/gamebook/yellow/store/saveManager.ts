...
export async function completeRun3(): Promise<void> {
    ...
    const merged: YellowSave = { ...mergedRaw, activeWorld: "live", ngplusWorld: null, ngplusOldTeam: null, run3World: null, ngplusUsed: true, run3Used: true }
    liveStash = null
    ngplusStash = null
    run3Stash = null
    ngplusOldTeam = null
