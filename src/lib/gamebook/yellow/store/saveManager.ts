...
export function snapshot(): YellowSave {
    ...
    const norm = (w: YellowSave | null): YellowSave | null =>
        w ? { ...w, pokedex: { seen: [...pdx.seen], caught: [...pdx.caught], seenAt: pdx.seenAt, firstCatch: pdx.firstCatch }, berrySecretKnown: w.berrySecretKnown || berryKnown, customDaemons: cds, craftsUsed, craftReady, activeWorld: "live" as const, ngplusWorld: null, ngplusOldTeam: null, run3World: null, replayWorld: null, replayRun: null, replayReturn: null, altProfiles: undefined } : null
