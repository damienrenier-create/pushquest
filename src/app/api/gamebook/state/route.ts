...
export async function POST(req: NextRequest) {
    ...
    if (
        ...
        !["bourgpates", "gym", "casino", "cave", "route1", "pepiteville", "gym_pepite", "casino_pepite", "shop_interior", "hautespates", "tower_floor_1", "tower_floor_2", "tower_floor_3", "tower_floor_4", "tower_floor_5", "macaron_ile", "shop_macaron", "veterinaire", "bibliotheque", "grass_sud", "muscuville", "la_mer", "bike_shop", "gym_muscuville", "casino_muscuville", "contest_hall", "mont_pasta_ventoux", "lasagnas_vegas", "lasagnas_construction", "lasagnas_hotel", "lasagnas_shop_habits", "lasagnas_shop_bouffe", "lasagnas_shop_rachat"].includes(mapId) ||
