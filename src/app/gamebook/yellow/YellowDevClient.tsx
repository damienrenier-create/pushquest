                ...
                return (
                    <div style={menuOverlayStyle} onClick={closeIt}>
                        <div style={menuBoxStyle} onClick={(e) => e.stopPropagation()}>
                            ...
                            {preview && (
                                <>
                                    <FusionPreviewCard name={preview.name} types={preview.types} stats={preview.stats} moves={preview.moves} level={preview.level} spriteSrc={officialFusionForParents(picks[0].speciesId, picks[1].speciesId)?.sprite} aSprite={getSpecies(picks[0].speciesId)?.sprite} bSprite={getSpecies(picks[1].speciesId)?.sprite} aId={picks[0].speciesId} bId={picks[1].speciesId} />
