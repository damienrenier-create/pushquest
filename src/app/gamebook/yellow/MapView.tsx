...
const NPC_SPRITES: Record<string, { url: string; frames: number; h?: number } | null> = {
    ...
    y_dome_dan_maitre: { url: "/yellow/sprites/npc_dome_mage.png", frames: 1, h: 2.0 }, // GARDIEN DES DAN : même skin que le gardien du Dôme (demande Sartay)
...
// firered_player_t.png : ordre STANDARD down/up/left/right (y=55/88/121/154). NE PAS toucher — vérifié correct en jeu.
//   (Contrairement aux planches Gen3/npc40 qui, elles, sont dans l'ordre down/left/right/up.)
