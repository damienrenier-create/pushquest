...
function RegisterForm() {
    ...
    // Lien "AMIS SIMPLIFIÉ" (nexus-fun-2026) : mode "fun" FORCÉ côté serveur (10000⚡ + 10 Nexus-Ball) + interface
                    ...
                    <div className="text-center mb-8">
                        ...
                        {isFunInvite ? (
                            <p className="mt-3 inline-block bg-emerald-50 text-emerald-700 border border-emerald-200 rounded-full px-3 py-1 text-xs font-semibold">
                                🎉 Mode fun — 10 000⚡ + 10 Nexus-Ball offerts, zéro prise de tête muscu !
                            </p>
                        ) : parrain ? (
