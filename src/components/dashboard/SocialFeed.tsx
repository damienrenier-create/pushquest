                                ...
                                <div key={ev.id} className="bg-white p-4 rounded-3xl border border-gray-100 shadow-sm flex items-center justify-between group transition-all hover:shadow-md">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div className="leading-tight">
                                            ...
                                            <p className="text-[10px] font-bold text-gray-400 mt-0.5 uppercase tracking-tighter italic">Score : {ev.newValue} {ev.badge?.metricType === 'MAX_BONUS' ? 'reps bonus' : ev.badge?.metricType === 'MAX_SET' ? 'reps' : 'points'}</p>
                                        </div>
                                    </div>
                                    <button 
