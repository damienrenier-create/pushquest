...
// ======== SCENE 5 ========
// Remaillage de la Scène 4 vers la Scène 5
for (const nodeId in data.nodes) {
    const node = data.nodes[nodeId];
    if (node.choices) {
        node.choices.forEach(c => {
            if (c.nextNodeId === 's5_pont_effondre_placeholder') {
                c.nextNodeId = 's5_pont_effondre';
            }
        });
    }
}
delete data.nodes['s5_pont_effondre_placeholder'];

// Ajout des nœuds de la Scène 5 (avec les modifications du Patch 6 incluses)
Object.assign(data.nodes, {
    "s5_pont_effondre": {
      "kind": "scene_porte",
      "axis": "J/P",
      "body": "Le pont de pierre a été emporté par une crue soudaine. Le torrent gronde. Linguini consulte sa carte, l'air sombre. « On doit passer aujourd'hui si on veut tenir le délai. » À côté de lui, Cannella recule, absolument terrifiée par l'eau.",
      "choices": [
        { "id": "A1", "text": "Organiser un chantier pour consolider les ruines (6h perdues).", "tag": "clever", "nextNodeId": "t_s5_A1", "monsterComment": "Une obstination magnifique. Tu as plié la nature à ton tableur Excel.", "mbti": {"J": 2}, "temperaments": {} },
        { "id": "A2", "text": "Faire un détour de 3h par les hauteurs rocailleuses.", "tag": "neutral", "nextNodeId": "t_s5_A2", "monsterComment": "Le choix de la raison. C'est lent, c'est sûr, c'est presque ennuyeux.", "mbti": {"J": 1}, "temperaments": {} },
        { "id": "B2", "text": "Transformer un pin déraciné par la crue en pont de fortune.", "tag": "bold", "nextNodeId": "t_s5_B2", "monsterComment": "Faire le funambule sur un tronc mouillé au-dessus d'une mort certaine. J'adore.", "mbti": {"P": 1}, "temperaments": {"courage": 1} },
        { "id": "B1", "text": "Ignorer l'eau et tailler un raccourci à la machette dans la forêt.", "tag": "wrong", "nextNodeId": "t_s5_B1", "monsterComment": "L'improvisation a ses limites, {nickname}. Et ses victimes.", "mbti": {"P": 2}, "temperaments": {"malice": 0.5} }
      ]
    },
    "t_s5_A1": {
      "kind": "tampon",
      "body": "Vous passez des heures dans la boue à tirer des troncs. Cannella, horrifiée pour ses soieries, hurle sur Linguini et l'accuse d'incompétence. Dans les gravats de l'ancien pont, vous récupérez une solide Corde d'ingénieur.",
      "choices": [ { "id": "c1", "text": "Ranger la corde et avancer", "tag": "neutral", "nextNodeId": "t_s5_bivouac", "mbti": {}, "temperaments": {} } ]
    },
    "t_s5_A2": {
      "kind": "tampon",
      "flags": { "boussole_ternie": true },
      "body": "Le sentier est rude mais sec. Cannella, soulagée d'éviter l'eau, finit par se plaindre de ses souliers ruinés. Furieuse, elle exige publiquement une baisse des primes de l'escorte. Sur le chemin, vous ramassez une Boussole ternie.",
      "choices": [ { "id": "c1", "text": "Prendre la boussole et continuer", "tag": "neutral", "nextNodeId": "t_s5_bivouac", "mbti": {}, "temperaments": {} } ]
    },
    "t_s5_B1": {
      "kind": "tampon",
      "body": "La progression est brutale. Soudain, un essieu lâche dans une ravine. La charrette de Grogno bascule. Il est entraîné et meurt écrasé sous ses marchandises. Cannella tombe dans un mutisme de terreur absolue. Vous récupérez la Machette du défunt.",
      "flags": { "grogno_dead": true },
      "choices": [ { "id": "c1", "text": "Laisser le corps et avancer dans le silence", "tag": "neutral", "nextNodeId": "t_s5_bivouac", "mbti": {}, "temperaments": {} } ]
    },
    "t_s5_B2": {
      "kind": "tampon",
      "body": "Cannella, paralysée, doit être portée par Linguini et Penne, qui s'épuisent et s'insultent. Vous sécurisez le passage. Au milieu du courant, le silencieux Brodo déloge une bourse en cuir des racines. Il l'ouvre : c'est un Silex de trappeur, intact.",
      "choices": [ { "id": "c1", "text": "Voir la trouvaille de Brodo", "tag": "neutral", "nextNodeId": "t_s5_B2_trouvaille", "mbti": {}, "temperaments": {} } ]
    },
    "t_s5_B2_trouvaille": {
      "kind": "tampon",
      "body": "Le Monstre flotte au-dessus de l'eau glaciale. « Prendre le temps de fouiller les poubelles de la rivière en frôlant la mort. J'adore. Que fais-tu de cette découverte, {nickname} ? »",
      "choices": [
        { "id": "c1", "text": "« Tu l'as trouvé, Brodo. Garde-le. » (Respect)", "tag": "neutral", "nextNodeId": "t_s5_bivouac", "monsterComment": "Tu laisses l'accessoire au vieux figurant. L'avenir nous dira si c'était judicieux.", "mbti": {}, "temperaments": {"compassion": 0.5} },
        { "id": "c2", "text": "« Range ça, aide-moi à tirer la corde ! » (Impatience)", "tag": "safe", "nextNodeId": "t_s5_bivouac", "monsterComment": "L'urgence avant la politesse. Tu viens de froisser un allié, mais on avance.", "mbti": {}, "temperaments": {} },
        { "id": "c3", "text": "Prendre la bourse et la jeter à l'eau.", "tag": "wrong", "nextNodeId": "t_s5_bivouac", "monsterComment": "Magnifique. Le type te montre sa trouvaille, tu la balances à la flotte. Une vraie performance.", "mbti": {}, "temperaments": {"compassion": -1} },
        { "id": "c4", "text": "Accepter le silex avec un signe de tête.", "tag": "clever", "nextNodeId": "t_s5_B2_silex_get", "monsterComment": "Tiens. Un accessoire qui atterrit dans tes poches. Garde ça précieusement.", "mbti": {}, "temperaments": {} }
      ]
    },
    "t_s5_B2_silex_get": {
      "kind": "tampon",
    ...
    "t_s5_bivouac": {
      "kind": "tampon",
      "body": "La nuit tombe enfin. Que vous ayez forcé le passage, bravé le courant ou perdu Grogno, la caravane a franchi l'obstacle au prix d'une fatigue immense. Autour d'un feu de camp crépitant, les regards sont sombres. Cannella s'est enfermée dans sa charrette.",
      "choices": [ { "id": "c1", "text": "Essayer de dormir", "tag": "neutral", "nextNodeId": "s6_conflit", "monsterComment": "Repose-toi, {nickname}. Écoute ce silence. C'est lourd, c'est froid, et tout le monde se regarde en chiens de faïence. Un vrai régal. Bref, dors.", "mbti": {}, "temperaments": {} } ]
    }
});

// ======== SCENE 6 ========
// S6 was added in the previous patch, but the placeholder s7_cuisinier_placeholder needs to be removed
// and funnel linked to s7_cuisinier.
if (data.nodes['t_s6_funnel'] && data.nodes['t_s6_funnel'].choices) {
...
"s8_philosophie": {
      ...
      "choices": [
        ...
        { "id": "B2", "text": "« Pour eux. Je ne tire pas des charrettes, je protège mes gens. »", "tag": "safe", "nextNodeId": "t_s8_phil_gens", "monsterComment": "Le berger et son troupeau. C'est presque émouvant, {nickname}.", "mbti": {}, "temperaments": {"compassion": 1} },
...
console.log('Patches 5 to 9 successfully linked and applied!');
